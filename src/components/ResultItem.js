export const ResultItem = {
  ...
  template: /*html*/ `
    <li :class="classes" class="mb-3 px-5 py-4 rounded-md shadow-md sm:mb-5">
      ...
      <div class="flex mt-2"><span v-html="linkIcon" class="mr-1"></span> <a :href="result.Link" target="_blank" rel="noopener" class="text-blue-500 break-all">{{result.Link}}</a></div>
